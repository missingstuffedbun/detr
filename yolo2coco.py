...
parser.add_argument('--image_dir', type=str, help="path of images")
parser.add_argument('--label_dir', type=str, help="path of labels")
parser.add_argument('--class_dir', type=str, help="path of class")
...
def yolo2coco(arg):
    if arg.image_dir or arg.label_dir or arg.class_dir:
        originImagesDir = arg.image_dir
        originLabelsDir = arg.label_dir
        print("Loading images from ",originImagesDir," labels from ",originLabelsDir)
        assert os.path.exists(originImagesDir)
        assert os.path.exists(originLabelsDir)
        with open(arg.class_dir) as f:
